...
public class PersonasHome {
	...
	public Personas merge(Personas detachedInstance) {
		...
		try {
			Personas result = (Personas) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Personas findById(java.lang.Integer id) {
		log.debug("getting Personas instance with id: " + id);
		try {
			Personas instance = (Personas) sessionFactory.getCurrentSession().get("com.lucatic.agenda.dao.Personas",
					id);
			if (instance == null) {
